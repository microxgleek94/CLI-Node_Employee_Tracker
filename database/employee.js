...
class dataQuery {
    ...
    findAllEmployees() {
        ...
        return connection.query(
            ...
            // the final table printed will show all the data from the "employee" and "role" tables, along w/ manger names and the mployee's role and corresponding departments
